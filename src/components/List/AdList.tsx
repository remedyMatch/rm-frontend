      ...
      {items.map((item) => (
        <div className={classes.resultItemWrapper}>
          <div
            className={clsx(
              classes.resultItem,
              item.requests.length > 0 && classes.resultItemWithRequests
            )}
          >
            ...
            <div className={classes.commentContainer}>
              ...
              <span className={classes.attributes}>
                {[
                  ...
                  item.useBefore &&
                    "MHD " +
                      item.useBefore.toLocaleDateString("de-DE", {
                        day: "2-digit",
                        month: "2-digit",
                        year: "2-digit",
                      }),
            ...
            <div className={classes.requestList}>
              <div className={classes.requestListHeader}>
                <span className={classes.requestListHeaderMain}>
                  {item.requests.length} offene Anfrage
                  {item.requests.length > 1 ? "n" : ""}
                </span>
              ...
              {item.requests.map((request) => (
                <div
                  ...
                  onClick={() =>
                    history.push(
                      "/konversation/" + request.conversationId || ""
                    )
                  }
                >
