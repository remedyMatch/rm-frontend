        ...
        <div className={classes.accountMenuButton}>
          ...
          <div className={classes.accountMenuText}>
            ...
            <Typography className={classes.accountMenuLocation}>
              {curInst?.standort.strasse} {curInst?.standort.hausnummer},{" "}
              {curInst?.standort.plz} {curInst?.standort.ort}
            </Typography>
          </div>

          <ArrowDropDown
            className={clsx(
              classes.accountMenuDropdown,
              open && classes.accountMenuDropdownActive
            )}
          />
        </div>
      </div>

      <Backdrop open={open || locationMenuOpen} className={classes.backdrop} />
              ...
              <ClickAwayListener onClickAway={closeMenu}>
                <div className={classes.accountMenuContainer}>
                  <Button
                    ...
                    startIcon={
                      <PersonPinCircle
                        className={classes.accountMenuActionIcon}
                      />
                    }
                    variant="text"
                  ...
                  <Button
                    ...
                    startIcon={
                      <Person className={classes.accountMenuActionIcon} />
                    }
                    variant="text"
                    className={classes.accountMenuAction}
                  >
