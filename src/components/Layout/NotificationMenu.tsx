...
const NotificationMenu: React.FC = () => {
    ...
    const notifications = useSelector((state: RootState) => state.benachrichtigungen.value || []);
    ...
    return (
        <>
            ...
            <div className={clsx(classes.notifications, open && classes.notificationsActive)}>
                <IconButton
                    ref={menuRef}
                    onClick={openMenu}>
                    <Badge
                                    ...
                                    <div className={classes.notificationButtons}>
                                        ...
                                        <Tooltip
                                            ...
                                            <Button
                                                ...
                                                disabled={notifications.filter(b => b.gelesen).length === 0}
