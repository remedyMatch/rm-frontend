...
const [
  gestellteBedarfAnfragenSlice,
  loadGestellteBedarfAnfragen,
] = createApiState<GestellteBedarfAnfrage[]>(name, url);

export { gestellteBedarfAnfragenSlice, loadGestellteBedarfAnfragen };
