...
const [
  konversationAngebotAnfragenSlice,
  loadKonversationAngebotAnfragen,
] = createApiMapState<GestellteAngebotAnfrage>(name, url);

export { konversationAngebotAnfragenSlice, loadKonversationAngebotAnfragen };
