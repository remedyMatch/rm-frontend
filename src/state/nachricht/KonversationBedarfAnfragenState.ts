...
const [konversationBedarfAnfragenSlice, loadKonversationBedarfAnfragen] = createApiMapState<GestellteBedarfAnfrage>(name, url);

export {
    konversationBedarfAnfragenSlice, loadKonversationBedarfAnfragen
};