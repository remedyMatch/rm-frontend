...
class CancelSentOfferDialog extends Component<Props, State> {
    state: State = {
        disabled: false
    };
    ...
    private onYes = () => {
        handleDialogButton(
            ...
            () => apiDelete("/remedy/" + (this.props.request!.bedarfId !== null ? "bedarf" : "angebot") + "/anfrage/" + this.props.request!.id)
        );
    };
