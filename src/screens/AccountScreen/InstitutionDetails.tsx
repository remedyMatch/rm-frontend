...
const InstitutionDetails: React.FC = () => {
  ...
  const [requestLocationDialogOpen, setRequestLocationDialogOpen] = useState(
    false
  );

  const onRequestLocationClicked = useCallback(
    () => setRequestLocationDialogOpen(true),
    []
  );
  const onRequestLocationDialogCancelled = useCallback(
    () => setRequestLocationDialogOpen(false),
    []
  );
  const onRequestLocationDialogSaved = useCallback(
    () => setRequestLocationDialogOpen(false),
    []
  );
  ...
  const institution = person?.institutionen?.find(
    (i) => i.institution.id === match.params.id
  );
