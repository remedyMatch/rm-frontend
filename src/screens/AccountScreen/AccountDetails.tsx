...
const AccountDetails: React.FC = props => {
    ...
    const mailLink = useMemo(
        () => encodeURI(`mailto:info@remedymatch.io?subject=Datenänderung&body=Sehr geehrte Damen und Herren,\r\n\r\n `
            ...
            <ContentCard
                ...
                )}>
                {
                    <div className={classes.container}>
                        <span className={classes.name}>{person?.vorname} {person?.nachname}</span>
